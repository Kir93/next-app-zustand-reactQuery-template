...
- [`AGENTS.md`](./AGENTS.md) — canonical conventions (tech stack, folder layout, code style, the React Compiler "no manual memoization" rule) plus Next.js framework rules. A vendor-neutral standard that Cursor, Copilot coding agent, Codex, and 30+ other AI tools read natively.
